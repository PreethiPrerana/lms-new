 ...
 */
    ...
    /**
     * Processes topics from a sheet and associates them with a course, returning the list of topics.
     */
    private List<Topic> processTopics(Sheet sheet, Course course) {
        ...
        while (iterator.hasNext()) {
            ...
            if (topicNames.contains(topicName)) {
                throw new DuplicateTopicException("Duplicate entries present in sheet."); // If found, throw an exception
            }
